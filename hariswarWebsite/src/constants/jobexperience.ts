export const jobExperiences = [
  ...
  },
  {
   ...
   },
   {
    ...
    description: "Volunteered to work with Dr. Xiong Zhang in a research on improving triaxial soil testing accuracy using the photogrammetry based methods. Assisted the research by generating the 2D results of the sand pictures from photographs which helped us to create a base for developing 3D models. Created a 3D models from 10+ different photo angles of the triaxial soil specimen developed with 3D models based on the different angles of pictures. The goal was to improve the accuracy of the point measurements and overall model accuracy.",
    technologies: ["Python", "MATLAB", "CAD", "Github"],
    icon: ""
   },
   {
